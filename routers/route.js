...
const as400 = require('../controllers/AsController');
...
module.exports = function (app) {
      ...
      app.get('/', isUserAllowed, function (req, res) {
            ...
            res.render('Dashboard/index', {'user': req.session.user.username});
      });
      ...
      app.get('/tables-basic', isUserAllowed, function (req, res) {
            ...
            res.render('Tables/tables-basic', {'user':req.session.user.username});
      });
      app.get('/tables-datatable', isUserAllowed, async (req, res)=> {
      ...
      app.get('/tables-editable', isUserAllowed, function (req, res) {
            ...
            res.render('Tables/tables-editable', {'user':req.session.user.username});
      });
